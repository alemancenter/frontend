...
import { CheckCircle2, FileDiff, Loader2, WandSparkles, XCircle } from 'lucide-react';
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              type="button"
              variant="secondary"
              disabled={!decision || !decision.can_auto_fix || isPending}
      ...
      <CardContent className="space-y-4">
        {!preview ? (
          ...
          <>
            ...
            {/* Action feedback — placed just above buttons so it's always in view when the user clicks */}
            {actionError && (
